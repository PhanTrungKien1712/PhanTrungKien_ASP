...
namespace ThoiTrangNam.Areas.Admin.Controllers
{
    public class LinkController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Slug,TypeLink,TableId,Status")] Link link)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Slug,TypeLink,TableId,Status")] Link link)
        {
            if (ModelState.IsValid)
            {
